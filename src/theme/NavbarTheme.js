export const navbarCustomTheme = {
  ...
  "link": {
    ...
    "active": {
      ...
      "off": "border-b border-gray-100 text-gray-700 hover:bg-gray-50  md:border-0 md:hover:bg-gray-100 md:hover:text-primary-700 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent md:dark:hover:text-white"
    },
    "disabled": {
